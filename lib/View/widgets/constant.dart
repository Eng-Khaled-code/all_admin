...
Padding dashboardCard(
    {String? lable, IconData? icon, int? counter, String? type = ""}) {
  return Padding(
...
Row adminProfileWidget({
  ...
  return Row(
    ...
    children: [
      ...
      CircleAvatar(
        backgroundImage:
            NetworkImage(image == "" ? Strings.appIconUrl : image!),
...
Container imageWidget(
    {String? image, double? height = 250, double? width = double.infinity}) {
  return Container(
