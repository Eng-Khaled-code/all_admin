...
class CustomDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String _userType = Strings.userInformation!.value.userType!;
      ...
      child: ListView(
        children: <Widget>[
          ...
          drawerBodyTile(Icons.settings, Colors.blue, "تحديث البيانات",
              () => Get.to(ProfilePage())),
          _userType == "full_access" || _userType == "admin"
              ? Container()
  ...
  drawerHeader() => Obx(
        () {
          String _imageUrl = Strings.userInformation!.value.imageUrl!;
          String _username = Strings.userInformation!.value.userName!;
          String _email = Strings.userInformation!.value.email!;
            ...
            currentAccountPicture: Padding(
              ...
              child: CircleAvatar(
                backgroundImage: NetworkImage(
                    _imageUrl == "" ? Strings.appIconUrl : _imageUrl),
