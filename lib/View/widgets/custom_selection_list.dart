...
class CustomSelectionList extends StatelessWidget {
  ...
  final String? selectedMiddlemanType;
  const CustomSelectionList({Key? key, this.list, this.onTap, this.listType,this.selectedMiddlemanType,this.selectedOperation})
      : super(key: key);
    ...
    return Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, position) => _typeItem(
              text: listType == "category_model_list"
                  ? list![position]['name']
                  : list![position]),
        ));
  }
