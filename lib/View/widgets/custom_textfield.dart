...
class _CustomTextFieldState extends State<CustomTextField> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    Icons.money
        :
    widget.lable=="عدد الطوابق"||widget.lable=="رقم الطابق"||widget.lable=="الكمية"
        ?
    ...
    Icons.category
            :
    widget.lable=="اسم الكتاب"
        ?
    CupertinoIcons.book
        :
    widget.lable=="العرض"||widget.lable=="نسبة الخصم"
        ?
    Icons.money_off
            :
    Icons.description;
    ...
    widget.lable=="كلمة المرور" ?
        ...
        :
    widget.lable=="سعر المتر"||widget.lable=="المساحة بالمتر المربع"||widget.lable=="السعر"||widget.lable=="نسبة الخصم"
        ?
    ...
    return Opacity(
      ...
      child: TextFormField(
        ...
        else if(widget.lable=="الإيميل"&&GetUtils.isEmail(value)==false)
        {
        ...
        else if((widget.lable=="عدد الطوابق"||widget.lable=="رقم الطابق"||widget.lable=="الكمية")&&isInteger(value)==false)
        {
          return "من فضلك إدخل رقم";
        }
        else if((widget.lable=="سعر المتر"||widget.lable=="السعر"||widget.lable=="نسبة الخصم")&&isNumeric(value)==false)
        {
        ...
        else  if(widget.lable=="نسبة الخصم"&&(double.tryParse(value)! >80 )){
