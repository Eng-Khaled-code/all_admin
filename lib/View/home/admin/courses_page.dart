...
class CoursesAdminPage extends StatefulWidget {
  ...
  CoursesAdminPage({Key? key}) : super(key: key);
  ...
  _dataWidget(){
    return Expanded(
      child: RefreshIndicator(
        onRefresh: ()async{
            await _adminController.operations(moduleName: "courses_list",operationType: "load");
          },
        child: Obx(()=>
      ...
      ?
      noDataCard(text: "لا توجد كورسات",icon: CupertinoIcons.book)
        :ListView.builder(
            ...
            itemBuilder: (context,position) {
              ...
              return CourseCard(
                  model: _model, adminController: _adminController,screenType:"admin");
            }),),
      ),
    );}
