...
class AddQuestion extends StatefulWidget {
   ...
   AddQuestion({Key? key,this.coursesController,this.quesId=0,this.question,this.videoId=0,this.trueIndex=1,this.res1="",this.res2="" ,this.res3="",this.res4="" ,this.opeType="add"}) :super(key: key);
...
class _AddQuestionState extends State<AddQuestion> {
  ...
  return Directionality(
    ...
    child: Scaffold(
      ...
      appBar:customAppbar(title:widget.opeType=="add"?"إضافة سؤال":"تعديل السؤال",actions: Container()),
      body: Obx(() =>
          Padding(
...
Column _resRowWidget(){
    return Column(
      children: [
    CustomText(text:"   رقم الإجابة الصحيحة",color: Colors.black,alignment: Alignment.topRight),
  ...
  _resItem({int? value}){
    return Row(
      children: [
          Radio<int>(value: value!,onChanged: (value){
            setState(() {
