        ...
        onPress: () {
          ...
          if(_formKey.currentState!.validate()){
            if(_image==null){
             ...
             _coursesController.courseOperations(operationType: "add",
            name: _name,desc: _desc,price: _price,categoryId: int.parse(courseCategoryId!),image: _image
          );}
          }
        },
    ...
    return ClipRRect(
      ...
      child: SizedBox(
          ...
          _image != null
              ?
          InkWell(
              onTap: ()=>getImageFile(onFileSelected: (File file)=>setState(()=>_image=file)),
              child:
  ...
  Container _categoryWidget() {
    ...
    return Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context,position)=>_typeItem(model:CourseCategoryModel.fromSnapshot(_coursesController.coursesCategories[position])),
        ));}
  ...
  Widget _typeItem({CourseCategoryModel? model}){
    ...
    return InkWell(
        ...
        child: Container(padding:const EdgeInsets.all(10),  margin :const EdgeInsets.symmetric(horizontal: 5),
            ...
            child: CustomText(text:model.name! ,color: con?Colors.white:Colors.black,alignment: Alignment.topCenter,)
        ));}
