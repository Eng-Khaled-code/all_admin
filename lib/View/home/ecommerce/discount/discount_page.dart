...
class DiscountPage extends StatelessWidget {
    ...
    return Expanded(
      ...
      noDataCard(text: "لا توجد عروض",icon: Icons.money_off)
        ...
        child: ListView.builder(
            itemCount:_ecommerceDataController.discountList.length,
            itemBuilder: (context,position){
              return DiscountCard(model:_ecommerceDataController.discountList[position],ecommerceController: _ecommerceDataController,);
  ...
  Padding _addDiscountWidget(BuildContext context) {
    ...
    Padding(
      ...
      text: "إضافة عرض",
      onPress: ()=>
       operationDialog(type: "إضافة عرض",controller: _ecommerceDataController),
