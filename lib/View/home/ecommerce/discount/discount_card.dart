...
class DiscountCard extends StatelessWidget {
  ...
  const DiscountCard({Key? key,this.model,this.ecommerceController}):super(key: key);
  ...
  Row _topRow(BuildContext context) {
    ...
    operationRow(()=>
        operationDialog(type: "تعديل العرض",id: model!.id,name: model!.name,desc: model!.description,persentage: model!.percentage,endTime: model!.endTime,controller:ecommerceController ),
        ()async{
      Get.back();
       await ecommerceController!.discountOperations(
