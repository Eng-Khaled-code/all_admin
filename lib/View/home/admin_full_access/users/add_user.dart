...
class _AddUserState extends State<AddUser> {
                    ...
                    Padding(
                      ...
                      children: [
                        ...
                        GestureDetector(onTap:()async {
                          ...
                          address:title);
                          await openMyMap(tapType:"get_address",lat:_currentPosition.latitude,long:_currentPosition.longitude
                          ,
                          title
                          :
                          title
                          ...
                          {
                          await openMyMap(tapType:"get_address",lat:_adminController.rxLat.value,long:_adminController.rxLong.value,title:_adminController.rxAddress.value);

                          }
                        },child: CustomText(color: _adminController.rxAddress.value.isNotEmpty?primaryColor:addressTextColor,fontSize: 16,text: _adminController.rxAddress.value==""?"اختر العنوان":_adminController.rxAddress.value)),

                        const SizedBox(height: 10.0),

                        const Align(alignment: Alignment.centerRight,child:Text("   الدولة المستهدفة")),
                        _countryWidget(),
  ...
  CustomSelectionList _countryWidget() {
    ...
    return CustomSelectionList(list:countries,listType: "country",onTap:  (String? text){
