...
class _AddBookState extends State<AddBook> {
        ...
        onPress: () {
          ...
          if(_formKey.currentState!.validate()){
            if(_image==null){
             ...
             _adminController.operations(moduleName: "books",operationType: "add",
            usernameOrCategory: _name,bookFile: _book,imageFile: _image
          );}
          }
        },
 ...
 TextFormField _bookFileWidget() {
    return TextFormField(
      onTap: ()=>getBookFile(onFileSelected: (File file)=>setState((){
        _book=file;
