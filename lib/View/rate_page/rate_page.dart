            ...
            body:  Obx(
                ()=> Container(
                  ...
                  await _userController.getComments();
                    ...
                    child :
                 _userController.isCommentLoading.value
      ?
      const Center(child: CircularProgressIndicator(),):_userController.userComments.isEmpty
      ?
      noDataCard("لا توجد تقييمات")
               :

          ListView.builder(itemCount:_userController.userComments.length,itemBuilder: (context,position){
